...
- `screenshots/v7/chatboard/current/`：V7.8 聊天主界面状态板截图证据，随状态和 7 层覆盖矩阵自动生成，当前应为 106 张。
